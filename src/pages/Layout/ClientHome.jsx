...
import PortfolioAnalysis from '../ClientPage/Person/PortfolioAnalysis'
import Products from '../ClientPage/Person/Products'
import Portfolios from '../ClientPage/Person/Portfolios'
...
const ClientHome = () => {
    ...
    const renderContent = () => {
        const moduleMap = {
            ...
            portfolio: <div><PortfolioAnalysis/></div>,
            products: <div><Products/></div>,
            investment: <div><Portfolios/></div>,

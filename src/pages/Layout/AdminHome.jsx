...
import { TeamOutlined, SettingOutlined, DashboardOutlined } from "@ant-design/icons";
...
const AdminHome = () => {
    ...
    const renderContent = () => {
        const moduleMap = {
            adminList: <div><AdminManage></AdminManage></div>,
            complianceList: <div><ComplianceManage></ComplianceManage></div>,
            riskList: <div><RiskeManage></RiskeManage></div>,
            advisorList: <div><AdvisorManage></AdvisorManage></div>,
            // ...
